...
public class CorporationsHandler {
	...
	public static void initCorporations() {
		...
		corporations.add(new Corporation("c3", Arrays.asList(Tag.SPACE), Map.of(Resource.CREDIT, 42, Resource.HEAT_PROD, 3), new CardEffect("c3", Arrays.asList(EffectType.PAY_FOR_CARD, EffectType.CARD_PLAY_INTENTION, EffectType.STANDARD_PROJECT, EffectType.BUY_COLONIE, EffectType.BUY_DELEGATE, EffectType.TRADING))));
		...
		corporations.add(new Corporation("c8", Arrays.asList(Tag.BUILDING), Map.of(Resource.CREDIT, 40), new CardEffect("c8", Arrays.asList(EffectType.PLACE_TILE))));
		...
		corporations.add(new Corporation("c12", Arrays.asList(Tag.JUVIAN), Map.of(Resource.CREDIT, 42, Resource.TITAN_PROD, 1, Resource.CREDIT_PROD, 1), new CardEffect("c12", Arrays.asList(EffectType.CARD_PLAY))));
		corporations.add(new Corporation("c13", Arrays.asList(Tag.VENUS, Tag.PLANT), Map.of(Resource.CREDIT, 47, Resource.PLANT_PROD, 1), new CardEffect("c13", Arrays.asList(EffectType.GLOBAL_PARAMETER_MODIFY))));
		...
		corporations.add(new Corporation("c26", Arrays.asList(Tag.NONE), Map.of(Resource.CREDIT, 45), new CardEffect("c25", Arrays.asList(EffectType.BUY_COLONIE))));
		...
		corporations.add(new Corporation("c28", Arrays.asList(Tag.BUILDING), Map.of(Resource.CREDIT, 54), new CardEffect("c28", Arrays.asList(EffectType.PLACE_TILE))));
		...
		corporations.add(new Corporation("c34", Arrays.asList(Tag.NONE), Map.of(Resource.CREDIT, 48, Resource.CREDIT_PROD, 4), new CardEffect("c34", Arrays.asList(EffectType.CHANGE_PRODUCTION, EffectType.CHANGE_RESOURCE))));
		corporations.add(new Corporation("c35", Arrays.asList(Tag.BUILDING), Map.of(Resource.CREDIT, 47), new CardEffect("c35", Arrays.asList(EffectType.PLACE_TILE))));
		...
		corporations.add(new Corporation("c38", Arrays.asList(Tag.MICROBE), Map.of(Resource.CREDIT, 44), new CardEffect("c38", Arrays.asList(EffectType.CARD_PLAY))));
	}
}
